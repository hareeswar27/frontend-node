...
const Technology = () => {
  ...
  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/technologyPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/technologyFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/technologyTopPost")
