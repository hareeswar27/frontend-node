...
export default function Bollywood() {
  ...
  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/bollywoodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/bollywoodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/bollywoodTopPost")
