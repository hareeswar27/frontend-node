...
export default function Hollywood() {
  ...
  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/hollywoodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/hollywoodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/hollywoodTopPost")
