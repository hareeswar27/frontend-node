...
const Fitness = () => {
  ...
  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/fitnessPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/fitnessFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/fitnessTopPost")
