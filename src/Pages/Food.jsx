...
export default function Food() {
  ...
  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/foodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/foodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-backend-g9is1xy8h-hareeswar27.vercel.app/foodTopPost")
